...
```
The "exercise" field should contain the text with 8 numbered blanks. The "options" field should include the 4 options for each of those blanks.
...
Ensure that it includes an "options" field with the options for each gap.
"""
